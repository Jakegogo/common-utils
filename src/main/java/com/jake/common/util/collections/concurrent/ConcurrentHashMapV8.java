 ...
 * exceptions encountered in the application of a supplied
 * function. Bear in mind when handling such exceptions that other
 * concurrently executing functions could also have thrown
 * exceptions, or would have done so if the first exceptions had
 * not occurred.
 *
...
public class ConcurrentHashMapV8<K,V> extends AbstractMap<K,V>
     ...
     * balancing code is updated from pre-jdk-utils.collections
     * (http://gee.cs.oswego.edu/dl/classes/utils.collections/RBCell.java)
