...
public class ConcurrentLinkedHashMap8<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    /*
    ...
    private Set<Entry<K, V>> descEntrySet;
        ...
        V put(K key, int hash, V val, boolean onlyIfAbsent) {
            ...
            try {
                ...
                if (e != null) {
                    ...
                    ConcurrentLinkedHashMap8.this.modCnt.increment();

                    e.modCnt = ConcurrentLinkedHashMap8.this.modCnt.intValue();
     ...
     */
    @SuppressWarnings({"unchecked"})
    public ConcurrentLinkedHashMap8(int initCap, float loadFactor, int concurLvl, int maxCap, QueuePolicy qPlc) {
     ...
     *      non-positive.
     */
    public ConcurrentLinkedHashMap8(int initCap, float loadFactor, int concurLvl, int maxCap) {
     ...
     */
    @SuppressWarnings({"unchecked"})
    public ConcurrentLinkedHashMap8(int initCap, float loadFactor, int concurLvl) {
     ...
     * @since 1.6
     */
    public ConcurrentLinkedHashMap8(int initCap, float loadFactor) {
     ...
     */
    public ConcurrentLinkedHashMap8(int initCap) {
     ...
     */
    public ConcurrentLinkedHashMap8() {
     ...
     * @param m the map
     */
    public ConcurrentLinkedHashMap8(Map<? extends K, ? extends V> m) {
    ...
    private abstract class HashIterator {
        ...
        HashIterator(boolean asc) {
            // TODO GG-4788 - Need to fix iterators for ConcurrentLinkedHashMap8 in perSegment mode
            if (qPlc != SINGLE_Q)
                throw new IllegalStateException("Iterators are not supported in 'perSegmentQueue' modes.");

            modCnt = ConcurrentLinkedHashMap8.this.modCnt.intValue();
        ...
        private Deque<HashEntry<K, V>> copyQueue() {
            ...
            Deque<HashEntry<K, V>> res = new LinkedDeque();
        ...
        public void remove() {
            ...
            ConcurrentLinkedHashMap8.this.remove(lastReturned.key);
    ...
    private abstract class AbstractKeySet extends AbstractSet<K> {
        /** {@inheritDoc} */
        @Override public int size() {
            return ConcurrentLinkedHashMap8.this.size();
        }
        ...
        @Override public boolean remove(Object o) {
            return ConcurrentLinkedHashMap8.this.remove(o) != null;
        }

        /** {@inheritDoc} */
        @Override public void clear() {
            ConcurrentLinkedHashMap8.this.clear();
        }
    }
    ...
    private abstract class AbstractEntrySet extends AbstractSet<Entry<K, V>> {
        ...
        @Override public boolean remove(Object o) {
            ...
            return ConcurrentLinkedHashMap8.this.remove(e.getKey(), e.getValue());
        }
