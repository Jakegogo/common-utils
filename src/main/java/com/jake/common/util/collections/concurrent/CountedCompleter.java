 ...
 * perform an action upon any exceptions.
 *
 ...
 * exceptional completion, the exceptions may be relayed to a task's
...
public abstract class CountedCompleter<T> extends ForkJoinTask<T> {
     ...
     * #compute} throws an exceptions, and this task has not already
     * otherwise completed normally. On entry to this method, this task
     * {@link ForkJoinTask#isCompletedAbnormally}.  The return value
     * of this method controls further propagation: If {@code true}
     * and this task has a completer that has not completed, then that
     * completer is also completed exceptionally, with the same
     * exceptions as this completer.  The default implementation of
     * this method does nothing except return {@code true}.
     *
     * @param ex the exceptions
     * @param caller the task invoking this method (which may
     * be this task itself)
     * @return {@code true} if this exceptions should be propagated to this
    ...
    /**
     * Supports ForkJoinTask exceptions propagation.
     */
