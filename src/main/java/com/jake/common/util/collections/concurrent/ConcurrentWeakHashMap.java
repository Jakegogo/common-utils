 ...
 * {@link WeakHashMap}, entries of this table are periodically
 ...
 *
 * <p>
 * This class is a member of the <a href="{@docRoot}/../technotes/guides/utils.collections/index.html">
 * Java Collections Framework</a>.
 *
 * @version  revision 5470 from http://viewvc.jboss.org/cgi-bin/viewvc.cgi/jbosscache/experimental/jsr166/src/jsr166y/
 * @author Doug Lea
...
public class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V>
     ...
     * @return
     */
    public int getKeyHashCode(Object key) {
        return key.hashCode();
    }
    ...
    final class WriteThroughEntry extends SimpleEntry<K,V>
    {
        ...
        public int hashCode() {
            return (key == null ? 0 : getKeyHashCode(key))
                    ^ (value == null ? 0 : getKeyHashCode(key));
        }
